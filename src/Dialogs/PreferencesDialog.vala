...
namespace Scratch.Dialogs {
    ...
    public class Preferences : Gtk.Dialog {
        ...
        private void create_layout (PluginsManager plugins) {        
            ...
            //create Behavior tab
            this.main_stack.add_titled (get_general_box (), "", _("Behavior"));
            
            //create Interface tab
            this.main_stack.add_titled (get_editor_box (), "", _("Interface"));
            ...
            if (Peas.Engine.get_default ().get_plugin_list ().length () > 0) {
                ...
                this.main_stack.add_titled (pbox, "", _("Extensions"));
            }
