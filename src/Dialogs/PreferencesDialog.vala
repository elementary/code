...
namespace Code.Dialogs {
    public class Preferences : Gtk.Dialog {
        ...
        construct {
            ...
            Code.settings.schema.bind ("indent-width", indent_width, "value", SettingsBindFlags.DEFAULT);
        ...
        private Gtk.Widget get_editor_box () {
            ...
            Code.settings.schema.bind ("draw-spaces", draw_spaces_combo, "active-id", SettingsBindFlags.DEFAULT);
            ...
            Code.settings.schema.bind ("right-margin-position", right_margin_position, "value", SettingsBindFlags.DEFAULT);
            Code.settings.schema.bind ("show-right-margin", right_margin_position, "sensitive", SettingsBindFlags.DEFAULT);
            ...
            Code.settings.schema.bind ("use-system-font", use_custom_font, "active", SettingsBindFlags.INVERT_BOOLEAN);

            select_font = new Gtk.FontButton ();
            select_font.hexpand = true;
            Code.settings.schema.bind ("font", select_font, "font-name", SettingsBindFlags.DEFAULT);
            Code.settings.schema.bind ("use-system-font", select_font, "sensitive", SettingsBindFlags.INVERT_BOOLEAN);
        ...
        private class SettingsSwitch : Gtk.Switch {
            public SettingsSwitch (string setting) {
                ...
                Code.settings.schema.bind (setting, this, "active", SettingsBindFlags.DEFAULT);
            }
        }
    }
}
