...
public class Scratch.CommentToggler {
    ...
    private static CommentType lines_already_commented (Gtk.Source.Buffer buffer,
                                                        Gtk.TextIter start,
                                                        Gtk.TextIter end,
                                                        uint num_lines,
    ...
    private static void remove_comments (Gtk.Source.Buffer buffer,
                                         Gtk.TextIter start,
                                         Gtk.TextIter end,
                                         uint num_lines,
                                         CommentType type,
    ...
    private static void add_comments (Gtk.Source.Buffer buffer,
                                      Gtk.TextIter start,
                                      Gtk.TextIter end,
                                      uint num_lines,
                                      CommentType type,
    ...
    public static void toggle_comment (Gtk.Source.Buffer? buffer) {
        if (buffer != null) {
