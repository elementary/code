/*
* Copyright 2013 Mario Guerriero <mefrio.g@gmail.com>
...
public class Scratch.Widgets.HeaderBar : Hdy.HeaderBar {
    public Code.FormatBar format_bar { get; private set; }
    public Gtk.Button templates_button { get; private set; }
    public Gtk.MenuButton share_app_menu { get; private set; }
    public Gtk.Menu share_menu { get; private set; }
    ...
    construct {
        ...
        templates_button = new Gtk.Button.from_icon_name ("text-x-generic-template", Gtk.IconSize.LARGE_TOOLBAR) {
            ...
            tooltip_text = _("Project templates")
        };
