...
public class Scratch.Plugins.Terminal : Peas.ExtensionBase,  Peas.Activatable {
    ...
    private void update_terminal_settings (string settings_schema) {
        ...
        switch(cursor_shape_setting) {
            case "Block": this.terminal.cursor_shape = CursorShape.BLOCK; break;
            case "I-Beam": this.terminal.cursor_shape = CursorShape.IBEAM; break;
            case "Underline": this.terminal.cursor_shape = CursorShape.UNDERLINE; break;
        }
