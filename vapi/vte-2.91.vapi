...
namespace Vte {
	...
	public class Terminal : Gtk.Widget, Atk.Implementor, Gtk.Buildable, Gtk.Scrollable {
		...
		[Version (since = "0.48")]
		public void spawn_async (Vte.PtyFlags pty_flags, string? working_directory, [CCode (array_length = false, array_null_terminated = true)] string[] argv, [CCode (array_length = false, array_null_terminated = true)] string[]? envv, GLib.SpawnFlags spawn_flags_, GLib.SpawnChildSetupFunc? child_setup, GLib.DestroyNotify? child_setup_data_destroy, int timeout, GLib.Cancellable? cancellable, TerminalSpawnAsyncCallback? callback = null);
